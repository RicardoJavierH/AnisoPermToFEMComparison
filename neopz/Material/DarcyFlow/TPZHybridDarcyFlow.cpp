...
int TPZHybridDarcyFlow::VariableIndex(const std::string &name) const {
 ...
 void TPZHybridDarcyFlow::Solution(const TPZVec<TPZMaterialDataT<STATE>> &datavec,
...
void  TPZHybridDarcyFlow::SetPermTensor(TPZFMatrix<STATE> permTensor)
{
...
void TPZHybridDarcyFlow::GetPermTensor(TPZVec<STATE> &coord,TPZFMatrix<STATE> &permTensor, TPZFMatrix<STATE> &invpermTensor )
{
