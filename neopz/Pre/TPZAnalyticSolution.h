...
struct TLaplaceExample1 : public TPZAnalyticSolution
{
    ...
    ESquareRootUpper, ESquareRootLower, ESquareRoot, ELaplace2D, EHarmonic3, EHarmonicPoly, EAnisoPerm};
    ...
    void GetPermeabilyTensor(TPZFMatrix<STATE> &perm, TPZFMatrix<STATE> &invperm);
    
    void SetPermeabilyTensor(const REAL &perm);
